...
Further developments for this project might involve creating dynamic excel sheet, expanding the number of frameworks, allowing users to upload an excel sheet, and anything else that helps the user better understand business security. 
